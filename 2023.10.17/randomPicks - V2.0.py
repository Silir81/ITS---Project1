def form_teams(no_of_teams, param_dataBase):
    ...
    # Ensure "Radu Videanu" and "Cezar Hurubean" are in Team 0
    pool_of_teams["Team 0"] = ["Radu Videanu", "Cezar Hurubean"]

    # Distribute the rest of the members
    ...
    print("Team distribution lenght:")
    for team_name, members in pool_of_teams.items():
