...
print("\nValoarea totala a cosului este: ", type(Total_valore_cos), Total_valore_cos, "RON"'\n')

# Introducerea limitei de buget
setare_buget = int(input("Introduceti bugetul alocat"'\n'))
#print Setare_buget:
...
while Total_valore_cos > setare_buget:
    ...
    print("\u0332".join(
        ...
        for key, value in cos_cumparaturi.items():
           print(f"{key}: {value}")
        print("\nFelicitari, te-ai incadrat in bugetul stabilit: ")
